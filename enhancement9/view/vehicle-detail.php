...
<head>
  ...
  <title><?php echo $vehicleDetails;?> vehicles | PHP Motors, Inc.</title> <!--link stylesheets-->
  <!--link stylesheets-->
...
<body>
  <main>
    ...
    <h1 class="details-view"><?php echo "$vehicle[invMake] $vehicle[invModel]";?> Vehicle Details</h1>
